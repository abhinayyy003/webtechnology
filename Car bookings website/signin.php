...
<?php
    if (isset($_POST['upload'])){
        ...
        if(($image_extention!= 'jpg') && ($image_extention!= 'png') && ($image_extention!= 'jpeg') && ($image_extention!= 'webp')){
        ...
        $query="INSERT INTO `user_data`(`name`,`email`,`number`,`password` ,`image`) VALUES ('$name_given_user','$email_given_user','$number_given_user','$password_given_user','$image_destination')";
