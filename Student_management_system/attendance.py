...
# Contains section and subject names
...
# Contains subject and teacher's name
...
# Function to assign teachers to sections without overlapping
def assign_teachers_to_sections(subjects, teachers):
    ...
    for teacher in teachers:
        for section in section_teacher_mapping:
            if not any(teacher['teacher'] == t['teacher'] for t in section_teacher_mapping[section]):
        ...
        for time_slot in time_slots:
            ...
            for section, teacher_list in section_teacher_mapping.items():
                ...
                if timetable[day][time_slot][section] is None:
                    ...
                    #{'subject': 'English', 'teacher': 'Mrs. Gray'}, then subject will be 'English'.
